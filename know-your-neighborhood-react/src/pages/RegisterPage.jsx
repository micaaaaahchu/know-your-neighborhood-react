...
const RegisterPage = () => {
  ...
  return (
    <MainLayout>
      <div className="flex justify-center mt-10 text-white mb-6">
        <form
          onSubmit={handleSubmit(onSubmitHandler)}
          className="p-[30px] bg-black w-full max-w-[500px] rounded-lg shadow-md shadow-primary"
        >
          <h2 className="text-center font-semibold text-3xl mb-3">Register with KYN</h2>
          {status === "SUCCESS" && (
