        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-7 mt-3 gap-5">
            ...
            <div className="md:col-span-3 text-gray-500 font-medium">
              ...
              <div className="flex">
              <FontAwesomeIcon icon={faLocationDot} className="fa-solid text-lg w-7" />
                <p>
                  {store.country}, {store.city}
                </p>
              </div>
              <div className="flex">
              <FontAwesomeIcon icon={farEnvelope} className="fa-regular text-lg w-7" />
                <p>{store.storeEmail}</p>
              </div>
              <div className="flex">
              <FontAwesomeIcon icon={faPhone} className="fa-solid text-lg w-7" />
              ...
              <div className="flex mt-5 bg-gray-50 rounded-lg py-2 px-3 md:w-[350px] shadow ">
                ...
                <div>
                  <Link to={`/profile/${user.name}/${user.userId}`}>
                    <p className="text-primary text-xl hover:text-red-400 transition duration-150">
                      {user.name}
                    </p>
                  </Link>
